...
\begin{enumerate}
    ...
    \end{figure}
    \item \begin{figure}[!ht]
    \input{figs/fig5.tex}  % Specify the path to your TikZ file
    \label{fig:c}
    \end{figure}
    \item \begin{figure}[!ht]
    \input{figs/fig6.tex}  % Specify the path to your TikZ file
    \label{fig:d}
    \end{figure}
\end{enumerate}
...
\begin{figure}[!ht]
\centering
    \input{figs/fig7.tex}  % Specify the path to your TikZ file
...
\begin{figure}[!ht]
\centering
    \input{figs/fig8.tex}  % Specify the path to your TikZ file
